...
def liftBed(fin, fout, funlifted):
    params = dict()
    params['LIFTOVER_BIN'] = '/home/local/ARCS/nz2274/Application/liftover/liftOver'
    params['OLD'] = fin
    params['CHAIN'] = '/home/local/ARCS/nz2274/Application/liftover/hg19ToHg38.over.chain.gz'
    params['NEW'] = fout
